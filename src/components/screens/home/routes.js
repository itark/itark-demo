...
import UsersSeeAll from './components/users';
...
const RootStack = createStackNavigator(
  {
    ...
    [ROUTE_NAMES.USERS_SEE_ALL]: {
      screen: UsersSeeAll,
      navigationOptions: ({ navigation }) => setDefaultHeaderLayout(navigation, 'Users'),
    },
